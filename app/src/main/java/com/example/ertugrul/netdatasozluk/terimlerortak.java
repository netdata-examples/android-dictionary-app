...
public class terimlerortak extends Activity {
    TextView textview;
    NodeList nodelist;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_ayarlar){
            Intent i = new Intent(terimlerortak.this, geriBildirim.class);
            startActivity(i);
        }
        else if(item.getItemId() == R.id.action_ayarlar2){
            Intent i = new Intent(terimlerortak.this, hakkinda.class);
            startActivity(i);
        }else{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        URL = terimlerSozlugu.urlVer;
        if (terimlerSozlugu.noDeLiTerSoz == null) {
            new DownloadXML().execute(URL);
            adapter2 = new ArrayAdapter<String>(this, R.layout.list_item, R.id.product_name, arrList);
        } else if (terimlerSozlugu.noDeLiTerSoz != null && kontrolUrl == URL) {
            for (int temp = 0; temp < terimlerSozlugu.noDeLiTerSoz.getLength(); temp++) {
                Node nNode = terimlerSozlugu.noDeLiTerSoz.item(temp);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(terimlerortak.this);
                for (int aw = 0; aw < terimlerSozlugu.noDeLiTerSoz.getLength(); aw++) {
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                terimlerortak.this.adapter2.getFilter().filter(cs);
            }
    ...
    private class DownloadXML extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(terimlerortak.this);
        ...
        public void onPostExecute(Void args) {
            for (int temp = 0; temp < nodelist.getLength(); temp++) {
                ...
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    String a = getNode("dc_Terim", eElement);
                    String b = getNode("dc_Aciklama", eElement);
                    kontrolUrl = terimlerSozlugu.urlVer;
                    arrList.add(a);
                    arrList2.add(b);
                    terimlerSozlugu.noDeLiTerSoz = nodelist;
                }
            }
            pDialog.dismiss();
        }
