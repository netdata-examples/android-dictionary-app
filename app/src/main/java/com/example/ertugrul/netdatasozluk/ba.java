...
public class ba extends Activity {
    ...
    String URL = "https://www.netdata.com/XML/4fc35986";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_ayarlar){
            Intent i = new Intent(ba.this, geriBildirim.class);
            startActivity(i);
        }
        else if(item.getItemId() == R.id.action_ayarlar2){
            Intent i = new Intent(ba.this, hakkinda.class);
            startActivity(i);
        }else{
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (vocabulary.baa != null) {
            for (int temp = 0; temp < vocabulary.baa.getLength(); temp++) {
                Node nNode = vocabulary.baa.item(temp);
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    Element eElement = (Element) nNode;
                    String b = getNode("dc_Meaning", eElement);
                    String a = getNode("dc_Phrasal_Verb", eElement);
                    String c = getNode("dc_Example_Sentence", eElement);
                    arrList.add(a);
                    arrList2.add(b);
                    id.add(c);
                }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(ba.this);
                for(int j=0;j<vocabulary.baa.getLength();j++){
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ba.this.adapter.getFilter().filter(cs);
            }
    ...
    private class DownloadXML extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ba.this);
