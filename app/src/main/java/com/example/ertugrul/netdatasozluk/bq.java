...
public class bq extends Activity {
    ...
    String URL = "https://www.netdata.com/XML/07e31172";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_ayarlar){
            Intent i = new Intent(bq.this, geriBildirim.class);
            startActivity(i);
        }
        else if(item.getItemId() == R.id.action_ayarlar2){
            Intent i = new Intent(bq.this, hakkinda.class);
            startActivity(i);
        }else{
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (vocabulary.bqq != null) {
            for (int temp = 0; temp < vocabulary.bqq.getLength(); temp++) {
                Node nNode = vocabulary.bqq.item(temp);
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    Element eElement = (Element) nNode;
                    String b = getNode("dc_Meaning", eElement);
                    String a = getNode("dc_Interjection", eElement);
                    String c = getNode("dc_Example", eElement);
                    arrList.add(a);
                    arrList2.add(b);
                    id.add(c);
                }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(bq.this);
                for(int j=0;j<vocabulary.bqq.getLength();j++){
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                bq.this.adapter.getFilter().filter(cs);
            }
    ...
    private class DownloadXML extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(bq.this);
