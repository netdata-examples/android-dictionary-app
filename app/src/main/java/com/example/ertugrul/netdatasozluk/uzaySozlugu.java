...
public class uzaySozlugu extends Activity {
    TextView textview;
    NodeList nodelist;
    ...
    String URL = "https://www.netdata.com/XML/5b80e56f";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_ayarlar){
            Intent i = new Intent(uzaySozlugu.this, geriBildirim.class);
            startActivity(i);
        }
        else if(item.getItemId() == R.id.action_ayarlar2){
            Intent i = new Intent(uzaySozlugu.this, hakkinda.class);
            startActivity(i);
        }else{
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (terimler.nodeUzay != null) {
            for (int temp = 0; temp < terimler.nodeUzay.getLength(); temp++) {
                Node nNode = terimler.nodeUzay.item(temp);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(uzaySozlugu.this);
                for(int j=0;j<terimler.nodeUzay.getLength();j++){
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                uzaySozlugu.this.adapter.getFilter().filter(cs);
            }
    ...
    private class DownloadXML extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(uzaySozlugu.this);
