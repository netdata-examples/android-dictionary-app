...
public class plaka extends Activity {
    TextView textview;
    NodeList nodelist;
    ...
    String URL = "https://www.netdata.com/XML/c457cc71";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_ayarlar){
            Intent i = new Intent(plaka.this, geriBildirim.class);
            startActivity(i);
        }
        else if(item.getItemId() == R.id.action_ayarlar2){
            Intent i = new Intent(plaka.this, hakkinda.class);
            startActivity(i);
        }else{
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (digerleri.nodePlaka != null) {
            for (int temp = 0; temp < digerleri.nodePlaka.getLength(); temp++) {
                Node nNode = digerleri.nodePlaka.item(temp);
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    Element eElement = (Element) nNode;
                    String b = getNode("dc_PlakaKodu", eElement);
                    String a = getNode("dc_Il", eElement);
                    String c = getNode("ID", eElement);
                    arrList.add(a);
                    arrList2.add(b);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(plaka.this);
                for (int j = 0; j < digerleri.nodePlaka.getLength(); j++) {
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                plaka.this.adapter.getFilter().filter(cs);
            }
    ...
    private class DownloadXML extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(plaka.this);
