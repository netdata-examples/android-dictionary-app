...
public class bl extends Activity {
    ...
    String URL = "https://www.netdata.com/XML/ff93cf9e";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_ayarlar){
            Intent i = new Intent(bl.this, geriBildirim.class);
            startActivity(i);
        }
        else if(item.getItemId() == R.id.action_ayarlar2){
            Intent i = new Intent(bl.this, hakkinda.class);
            startActivity(i);
        }else{
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (vocabulary.bll != null) {
            for (int temp = 0; temp < vocabulary.bll.getLength(); temp++) {
                Node nNode = vocabulary.bll.item(temp);
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                bl.this.adapter.getFilter().filter(cs);
            }
    ...
    private class DownloadXML extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(bl.this);
