...
public class bc extends Activity {
    ...
    String URL = "https://www.netdata.com/XML/86d8a60d";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_ayarlar){
            Intent i = new Intent(bc.this, geriBildirim.class);
            startActivity(i);
        }
        else if(item.getItemId() == R.id.action_ayarlar2){
            Intent i = new Intent(bc.this, hakkinda.class);
            startActivity(i);
        }else{
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (vocabulary.bcc != null) {
            for (int temp = 0; temp < vocabulary.bcc.getLength(); temp++) {
                Node nNode = vocabulary.bcc.item(temp);
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    Element eElement = (Element) nNode;
                    String b = getNode("dc_Word", eElement);
                    String a = getNode("dc_Definition", eElement);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(bc.this);
                for(int j=0;j<vocabulary.bcc.getLength();j++){
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                bc.this.adapter.getFilter().filter(cs);
            }
    ...
    private class DownloadXML extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(bc.this);
